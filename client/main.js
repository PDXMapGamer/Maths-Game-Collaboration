...
function timerEventHandler() {
  ...
  for (
    ...
    function timerCountdown() {
      ...
      timerContainer.appendChild(timerBead);
  ...
  // startButton; //No idea what this is doing here
...
function timeCounterEventHandler() {
  ...
  let timerCounter = setInterval(function () {
    ...
    if (seconds < 0) {
      ...
      setTimeout(() => {
        alert(`Time is up your score is will be submitted to the leaderboard. You scored ${score} points`);
      }, 500);
